...
Date:    2018/06/08
Description:
vSphere_DeleteVMs.ps1 is PowerShell script to automate the
deletion of Virtual Machines (VMs). 
...
Write-Host ">>> You are about to DELETE the following VMs:"
...
Write-Host ">>> WARNING!!! You are about to delete VMs..."
