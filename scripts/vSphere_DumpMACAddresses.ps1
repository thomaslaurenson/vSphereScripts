...
Date:    2018/06/08
Description:
vSphere_DumpMACAddresses.ps1 is PowerShell script to automate extraction
of all MAC addresses on a vSphere server.
...
Foreach ($vm in $sorted_vms) 
{
    # Get network adapted information
    ...
    Write-Host $VMName, $VMIP4, $MACAddress
}